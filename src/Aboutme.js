...
function Aboutme() {
  ...
  <div className="about-me__body">
        ...
        <div className="languages">
            <img src="https://raw.githubusercontent.com/ChittojiMuraliSreeKrishna/images/main/images/icons/html.png?token=AO3RFNBHUFV5LR4CNCCDFMTAOEW3E" className="icons" alt="" />
            <img src="https://raw.githubusercontent.com/ChittojiMuraliSreeKrishna/images/main/images/icons/css.png?token=AO3RFNFJHTPZ6PG2F3HRMMTAOEW42" className="icons" alt="" />
            <img src="https://raw.githubusercontent.com/ChittojiMuraliSreeKrishna/images/main/images/icons/javascript.png?token=AO3RFNCD325UI2ZE3EHHTJTAOEW6C" className="icons" alt="" />
            <img src="https://raw.githubusercontent.com/ChittojiMuraliSreeKrishna/images/main/images/icons/python.png?token=AO3RFNAFIPK5YSBD2JADOKDAOEW7W" className="icons" alt="" />
        </div>
      </div>
      </section>
    </div>
